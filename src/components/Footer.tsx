const Footer = () => (
  <footer className="bg-[#F1F2F6] dark:bg-gray-900">
    <div className="mx-auto w-full lg:max-w-[85%] p-4 py-6 lg:py-8">
      <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
          <a href="https://flowbite.com/" className="flex items-center">
            <span className="footer-logo self-center text-2xl font-semibold whitespace-nowrap text-emerald-400 text-[32px] leading-loose">
              WAVEFUEL
            </span>
          </a>
        </div>
